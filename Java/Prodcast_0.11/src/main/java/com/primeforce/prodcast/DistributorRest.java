...
public class DistributorRest {
    ...
    public ProdcastDTO saveExpense(@FormParam("expenseDate") String expenseDate, @FormParam("account") String account, @FormParam("catgId") int categoryId,
                                   ...
                                   @FormParam("amount") double amount, @FormParam("payMode") String paymode, @FormParam("employeeId") String userId,@FormParam("expenseId") String expenseId) {
        ...
        try {
            ...
            {
                rowCount = databaseManager.updateExpense(0,Long.parseLong(expenseId),account, categoryId, desc1, desc2, amount, paymode, userId);
